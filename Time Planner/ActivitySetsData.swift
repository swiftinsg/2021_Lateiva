...
class ActivitySetssData: ObservableObject {
    ...
    let sampleActivitySetss = [ActivitySets(name: "This is a sample", activities: [Activity(name1: "Create your own Now", timeSpending: 2, Percentage: "100%", Priority: "Click on the + icon", minTime: 1, maxTime: 5)])]
