...
class ActivitySetssData: ObservableObject {
    ...
    let sampleActivitySetss = [ActivitySets(name: "This is a sample", activities: [Activity(name1: "Edit this Activity!", timeSpending: 2, Percentage: "100%", Priority: "High Priority", minTime: 1, maxTime: 5)])]
